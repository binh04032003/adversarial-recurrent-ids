...
\caption{Recall for unmodified flows and \gls{ars} for each attack type in CIC-IDS-2017. For ``PortScan, Firewall'' recall never falls under 66\%: The adversary does not succeed and the \gls{ars} is $\infty$.}
