...
\autoref{tab:performance_results} shows the achieved classification performance when evalutuating metrics per packet and per flow and includes performance results for an MLP classifier from~\cite{bachl_walling_2019} for comparison.
