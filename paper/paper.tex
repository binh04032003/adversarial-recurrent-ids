...
The most obvious defense, which is only possible because of the nature of the dataset, is to simply omitting features an attacker can manipulate. We try two different approaches:
\begin{itemize}[topsep=0pt,wide,labelwidth=!,labelindent=0pt]
