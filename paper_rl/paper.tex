...
In what follows, we explore two technical details on how decisions are performed, either continuously or gradually. 

\begin{figure}
\center
  \includegraphics[width=0.3\textwidth]{img/rnn-sampling}
