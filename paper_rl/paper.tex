...
Conversely, \gls{rnn}-based \glspl{ids} has been shown to perform very well. In \cite{hartl_explainability_2019}, authors build a LSTM-based recurrent classifier for Network Intrusion Detection and further develop explainability methods as well as recurrent-classifiers security assessment.
...
\setrow{\bfseries}Sparsity & 0\% & 76.3\% & 76.5\% & 76.8\% \\ \midrule
