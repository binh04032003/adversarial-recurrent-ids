...
The higher sparsity in UNSW-NB15 is caused by the fact that it has more packets per flow on average and thus \ours{} achieves higher sparsity even by sampling the same number of packets as in CIC-IDS-2017.
